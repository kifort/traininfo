...
//TODO icon for '->'
function showTimetable($tripCollection){
...
?>
        ...
        <td class="officialTripTime"><?php echo $trip->getBeginTime()->official->departure . " - " . $trip->getEndTime()->official->arrival;?></td>
...
<?php
	...
	?>
        ...
        <td class="officialTripChapterTime"><?php echo 
        	...
        	$tripChapter->train->timetable[$tripChapter->userToStation->stationName]->official->arrival;?>
       	</td>
